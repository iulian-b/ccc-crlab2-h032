...
function load_pdf() {
	if (mobileCheck()) {
		...
		if (window.matchMedia("(orientation: portrait)").matches) {
			// MOBILE - PORTRAIT
			frameElement.parentElement.parentElement.style.top='10%';
			frameElement.parentElement.parentElement.style.left='unset';	
		} else {
			// MOBILE - LANDSCAPE
			frameElement.parentElement.parentElement.style.bottom='2px';
			frameElement.parentElement.parentElement.style.left='2%';
			// frameElement.parentElement.parentElement.style.left='unset';	
			// frameElement.parentElement.parentElement.style.bottom='unset';
		}
	} else {
		// DESKTOP
