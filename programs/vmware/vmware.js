...
var go_to = async function (address, action_name = "go") {
	...
	set_title("VMware - Sinclair OS-9");
	...
	if (is_url) {
		...
		$("#status-bar-right-icon").attr({
			src: getIconPath("sinclair-updates", 16),
		}).show();
		$("#status-bar-right-text").text("Sinclair OS-9");
	} else {
