...
function update_title() {
	document.title = (file_name || default_file_name_for_title) + " - MDView";
...
function load_from_blob(blob) {
	...
	file_reader.onload = function () {
		// $textarea.insertAdjacentHTML('beforeend', `<p>` + file_reader.result + `</p>`);
...
if (file_path) {
	...
	try {
		$textarea.insertAdjacentHTML('beforeend', localStorage["notepad:" + local_storage_document_id] || "");
